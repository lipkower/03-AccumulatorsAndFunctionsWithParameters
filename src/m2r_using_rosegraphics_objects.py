...
#            It draws the objects that've been attached to the window, without it
#            the objects will not be drawn.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            It is necessary when the use does not want the window to close
#            automatically after running the code. Instead, this command will
#            close the window after a click of the mouse. If there wasn't the call
#            after the code, the window will automatically close after the code completes.
#
